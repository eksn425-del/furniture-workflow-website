...
LOCAL_ENV_KEYS = frozenset({
    ...
    "LOCAL_REVIEW_MODE",
    "WEBSITE_MODEL_MODE",
    "WEBSITE_BACKGROUND_WORK_PAUSED",
    "LUNAMAX_MODEL_MODE",
    "PROVIDER_MODE",
    ...
    "WEBSITE_SITE_SCAN_TIMEOUT_SECONDS",
    ...
    "WEBSITE_BRAIN_AGENT_ENABLED",
    "WEBSITE_BRAIN_AGENT_MAX_STEPS",
    "CODEX_BRIDGE_ROOT",
    "CODEX_BRIDGE_TIMEOUT_SECONDS",
    "CODEX_BRIDGE_POLL_SECONDS",
    ...
    "BLENDER_EXECUTABLE",
    "BLENDER_DIMENSION_TOLERANCE",
    "BLENDER_ASPECT_RATIO_LIMIT",
