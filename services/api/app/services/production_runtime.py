...
class ProductionRuntimeService:
    ...
    def _contract(self, session, job: ProductionJob, workspace: Path) -> tuple[Path, Path, dict[str, Any]]:
        ...
        contract = {
            ...
            "dimension_anchor_policy": str(policy.get("dimension_anchor_policy") or "FULL_ONLY"),
            "dimension_anchor_axis": policy.get("dimension_anchor_axis"),
            "allow_non_anchor_dimension_error": bool(policy.get("allow_non_anchor_dimension_error", False)),
